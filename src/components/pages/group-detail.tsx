...
const groupProfiles: Record<string, { name: string; image: string; members: number; balance: number; totalSpent: number; created: string; location: string }> = {
  cecina: { name: "Vacanza a Cecina", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=400&h=300&fit=crop", members: 4, balance: 47.50, totalSpent: 1240.00, created: "Jun 2026", location: "Cecina, Italy" },
  topolini: { name: "I Tre Topolini", image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=400&h=300&fit=crop", members: 4, balance: -15.00, totalSpent: 890.50, created: "May 2026", location: "Milan, Italy" },
  weeknd: { name: "The Weeknd 27/7", image: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&h=300&fit=crop", members: 3, balance: 0, totalSpent: 540.00, created: "Jul 2026", location: "Rome, Italy" },
  universita: { name: "Università '25", image: "https://images.unsplash.com/photo-1523050854058-8df90110c476?w=400&h=300&fit=crop", members: 6, balance: 120.00, totalSpent: 2100.00, created: "Sep 2025", location: "Bologna, Italy" },
}

const memberList: Record<string, { name: string; avatar: string; balance: number }[]> = {
  cecina: [
    { name: "You", avatar: "", balance: 47.50 },
    { name: "Nasty", avatar: "", balance: -24.50 },
    { name: "Pippo", avatar: "", balance: -15.00 },
    { name: "Grecia <3", avatar: "", balance: -8.00 },
  ],
}

const settlHistory = [
  { id: 1, actor: "Nasty", description: "Paid for Airbnb — split 4 ways", amount: 190.00, yourShare: 47.50, status: "settled" as const, date: "Jul 25, 2026" },
  { id: 2, actor: "Pippo", description: "Grocery run at Coop", amount: 45.80, yourShare: 11.45, status: "pending" as const, date: "Jul 24, 2026" },
  { id: 3, actor: "You", description: "Dinner at Ristorante da Mario", amount: 120.00, yourShare: 30.00, status: "settled" as const, date: "Jul 22, 2026" },
  { id: 4, actor: "Grecia <3", description: "Beach umbrellas & chairs", amount: 60.00, yourShare: 15.00, status: "overdue" as const, date: "Jul 20, 2026" },
  { id: 5, actor: "You", description: "Gas for the road trip", amount: 85.00, yourShare: 21.25, status: "settled" as const, date: "Jul 18, 2026" },
]
