...
import { ArrowUpRight, ArrowDownRight, UsersIcon, ReceiptIcon, CheckCircle2, Clock } from "lucide-react"
  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
            ...
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem className="hidden md:block">
                  <BreadcrumbLink href="#" className="text-purple-200/80">
                    Dashboard
                  </BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator className="hidden md:block text-white/20" />
                <BreadcrumbItem>
                  <BreadcrumbPage className="text-purple-100">Overview</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="flex flex-1 flex-col gap-6 p-6 pt-0 bg-gradient-to-br from-[#110B3B] via-[#1A1250] to-[#0F0A2E]">
          {/* Welcome */}
          <div className="relative mt-2">
            ...
            <div className="relative">
              ...
              <p className="mt-2 text-purple-200/70 text-sm">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <InfoCard
              ...
              icon={<ReceiptIcon className="size-4 text-purple-300" />}
            ...
            <InfoCard
              ...
              icon={<ArrowDownRight className="size-4 text-red-400" />}
            ...
            />
            <InfoCard
              title="Pending Settls"
              value="12"
              description="Awaiting response"
              icon={<Clock className="size-4 text-amber-400" />}
              trend={{ value: "3 due today", up: true }}
            />
          </div>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={220}>
                  <AreaChart data={spendingData}>
                    ...
                    <Tooltip
                      contentStyle={{
                        backgroundColor: "rgba(17,11,59,0.9)",
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="bg-[#110B3B]/60 backdrop-blur-xl border-white/20 shadow-2xl">
              ...
              <CardContent className="space-y-3">
                <ActivityItem
                  name="Nasty"
                  description="Paid you €24.50 for Cecina trip"
                  time="2h ago"
                  icon={<CheckCircle2 className="size-4 text-emerald-400" />}
                />
                <ActivityItem
                  name="Pippo"
                  description="Owes you €15.00 for pizza"
                  time="5h ago"
                  icon={<Clock className="size-4 text-amber-400" />}
                />
                <ActivityItem
                  name="Grecia <3"
                  description="Settled €42.00 — Concert tickets"
                  time="1d ago"
                  icon={<CheckCircle2 className="size-4 text-emerald-400" />}
                />
                <ActivityItem
                  name="GiovAnge"
                  description="Owes you €8.50 for coffee"
                  time="2d ago"
                  icon={<Clock className="size-4 text-amber-400" />}
                />
              </CardContent>
